// jsk :clang -Wimplicit-int small.c
...
void declglb(typ)            /* typ is cchar or cint */
        int typ;
...
void addglb(sname,id,typ,value)
        char *sname,id,typ;
        int value;
{       char *ptr;
...
void addloc(sname,id,typ,value)
        char *sname,id,typ;
        int value;
{       char *ptr;
