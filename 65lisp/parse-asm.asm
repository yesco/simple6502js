...
;;; why aren't the FUNC below working?

.export _iorulesend,_iorulesstart
_iorulesstart:  
_iorulesend:

.export _memoryrulesstart,_memoryrulesend
_memoryrulesstart:  
_memoryrulesend:   

.export _oprulesstart,_oprulesend
_oprulesstart:  
_oprulesend:    

FUNC iorulesstart
FUNC iorulesend
FUNC memoryrulesstart
FUNC memoryrulesend
FUNC oprulesstart
FUNC oprulesend
...
.include "rules-expr.asm"

.else

.include "rules-E-C-D.asm"
